                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('update')}}" method="post">
                            @csrf
                            <input type="hidden" name="buku_id" id="" value="{{$edit_buku->id}}">
                            <div class="mb-3">
                                <label for="formGroupExampleInput" class="form-label">Judul</label>
                                <input type="text" name="judul" value="{{$edit_buku->judul}}" class="form-control" id="formGroupExampleInput" placeholder="Enter Judul">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="pengarang" class="form-control" value="{{$edit_buku->pengarang}}" id="formGroupExampleInput2" placeholder="Enter pengarang">
                                @error('pengarang')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                <label for="formGroupExampleInput2" class="form-label">Tanggal Publikasi</label>
                                <input type="date" name="tanggal_publikasi" value="{{$edit_buku->tanggal_publikasi}}" class="form-control" id="formGroupExampleInput2" placeholder="Enter tanggal_publikasi">
