                    ...
                    <div class="card-body">
                        <form action="{{route('store')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="judul" value="{{old('judul')}}" class="form-control" id="formGroupExampleInput" placeholder="Enter Judul">
                                @error('judul')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="pengarang" name="pengarang" value="{{old('pengarang')}}" class="form-control" id="formGroupExampleInput2" placeholder="Enter pengarang">
                                @error('pengarang')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal_publikasi" value="{{old('tanggal_publikasi')}}" class="form-control" id="formGroupExampleInput2" placeholder="Enter Tanggal Publikasi">
