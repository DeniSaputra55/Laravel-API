    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="card">
                    <div class="card-header">Tambah Data Todo List</div>
                    @if(Session::has('fail'))
                    ...
                    <div class="card-body">
                        <form action="{{route('store')}}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="todo" value="{{old('todo')}}" class="form-control" id="formGroupExampleInput" placeholder="Enter todo">
                                @error('todo')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" name="tanggal" value="{{old('tanggal')}}" class="form-control" id="formGroupExampleInput2" placeholder="Enter tanggal">
                                @error('tanggal')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            <div class="mb-3">
                                ...
                                <input type="time" name="jam" value="{{old('jam')}}" class="form-control" id="formGroupExampleInput2" placeholder="Enter Jam">
                                @error('jam')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
