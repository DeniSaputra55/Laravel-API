        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#about">tanggal</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="card">
                    <div class="card-header">
                        <a href="/add/todo" class="btn btn-success btn-sm float-end">Tambah Data</a>
                    </div>
                        ...
                        <table class="table table-sm table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$item->status}}</td>
                                    <td>
                                        <a href="/todo/{{$item->id}}" class="btn btn-primary btn-sm">
                                    ...
                                    <td>
                                        <a href="{{ route('todo.show', $item->id) }}" class="btn btn-info btn-sm">
