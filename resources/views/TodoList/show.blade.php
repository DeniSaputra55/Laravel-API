    ...
    <section id="about">
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="card">
                    <div class="card-header">Detail Data Todo List</div>
                    @if (Session::has('fail'))
                    <span class="alert alert-danger p-2">{{Session::get('fail')}}</span>
                    @endif
                    <div class="card-body">
                        <div class="mb-3">
                            <strong>Todo:</strong> {{ $show_todo->todo }}
                        </div>
                        <div class="mb-3">
                            <strong>Tanggal:</strong> {{ $show_todo->tanggal }}
                        </div>
                        <div class="mb-3">
                            <strong>Jam:</strong> {{ $show_todo->jam }}
                        </div>
                        <div class="mb-3">
                            <strong>Status:</strong> {{ $show_todo->status }}
                        </div>
                    </div>
